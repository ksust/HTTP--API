...
/*********************** 获取信息 *******************************************/
    ...
    /**
     * 获取收取图片信息
     * @param $imageFile  即[CQ:image,file=04AE5073B45B24AAC93841D010603049.jpg]中的04AE5073B45B24AAC93841D010603049.jpg
     * @return mixed json['url'=>,'width'=>,...]
     */
    public function getImageInfo($imageFile){
        $sendArr['Func']=__FUNCTION__;
        $sendArr['Msg']=$imageFile;
        return json_decode($this->sendData(IRSDK::$serverURL,$sendArr),true);
    }
