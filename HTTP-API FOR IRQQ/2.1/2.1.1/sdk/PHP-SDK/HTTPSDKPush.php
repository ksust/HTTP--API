...
class HTTPSDKPush
{
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GROUP_JOIN, 0, 0, $group, '', $reason, 0, 0);
        return json_decode($this->sendData(), true);
    }
    ...
    public function disGroupCreate($disName, $qqList = [])
    {
        ...
        $this->addDataCell(HTTPSDKPush::$TYPE_DIS_CREATE, 0, 0, '', '', $disName, $qqListStr, 0);
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_DIS_QUIT, 0, 0, $disGroupId, '', '', 0, 0);
        return json_decode($this->sendData(), true);
    }
    ...
    public function disGroupKick($disGroupId, $qqList = [])
    {
        ...
        $this->addDataCell(HTTPSDKPush::$TYPE_DIS_KICK, 0, 0, $disGroupId, '', $qqListStr, 0, 0);
        return json_decode($this->sendData(), true);
    }
    ...
    public function disGroupInvite($disGroupId, $qqList = [])
    {
        ...
        $this->addDataCell(HTTPSDKPush::$TYPE_DIS_INVITE, 0, 0, $disGroupId, '', $qqListStr, 0, 0);
        return json_decode($this->sendData(), true);
    }
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GROUP_INVITE, 0, 0, $groupId, '', $qq, 0, 0);
        return json_decode($this->sendData(), true)['Result'];
    }
    /*********************** 获取信息 *******************************************/
    /**
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_LIKE_COUNT_GET, 0, 0, '', $qq, '', '', 0);
        return json_decode($this->sendData(), true)['Result'];
    }
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GET_DIS_LIST, 0, 0, '', '', '', '', 0);
        return json_decode($this->sendData(), true)['Result'];
    }
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GET_QQ_LEVEL, 0, 0, '', $qq, '', '', 0);
        return json_decode($this->sendData(), true)['Result'];
    }
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GET_QQ_LEVEL, 0, 0, $groupId, $qq, '', '', 0);
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GET_QQ_ONLINE_STATUS, 0, 0, '', $qq, '', '', 0);
        return json_decode($this->sendData(), true)['Result'] == 1;
    }
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GET_QQ_IS_FRIEND, 0, 0, '', $qq, '', '', 0);
        return json_decode($this->sendData(), true)['Result'] == 1;
    }
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_GET_QQ_ROBOT_INFO, 0, 0, '', '', '', '', 0);
        return $this->sendData();
    }
    ...
    {
        $this->addDataCell(HTTPSDKPush::$TYPE_SET_INPUT_STATUS, 0, 0, '', $qq, '', '', 0);
        return json_decode($this->sendData(), true)['Result'];
    }
